  ...
  render() {
        ...
        <table className={classes.Table}>
          ...
          {refreshedPublisher.map((publisher, index) => {
            return (
              <tr>
                <td>{index + 1}</td>
                <td key={publisher.publisherId}>{publisher.publisherName}</td>
                <td>
                  <Link to={"/admin/publisher/edit/" + publisher.publisherId}>
                    Edit
                  </Link>
                </td>
              </tr>
    ...
    return (
      <div className={classes.Greetings}>
        ...
        />
        <div>
          <Link to="/admin/publisher/add" className={classes.Link}>
            Add New Publisher
          </Link>
        </div>
